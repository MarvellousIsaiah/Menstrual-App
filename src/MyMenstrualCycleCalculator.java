...
public class MyMenstrualCycleCalculator {
    ...
    public String ovulationMaximumRange(String[] dates) {
        ...
        return calender.get(Calendar.YEAR) + "" +
                " - " + periodMonths[month1-1] +
                " - " + calender.get(Calendar.DATE);


    }

    public void displayCalculatorInMainMethod() {
        Scanner scan = new Scanner(System.in);
        MyMenstrualCycleCalculator menses = new MyMenstrualCycleCalculator();
        ...
        System.out.printf("if your period starts%n%s%n%nif the average cycle length of your menstrual cycle is :%n%d%n%nyour estimated" +
                " fertile window is between : %n%s    ->      %s%n%n your estimated ovulation date is:%n%s%n%nyour menstrual cycle should end by : %n%s", java.util.Arrays.toString(dates), averageCycleLength, ovulationMinimumRange, ovulationMaximumRange, ovulationMaximumRange,estimatedEndOfPeriodDate);
    ...
    public static void main(String[] args) {
        MyMenstrualCycleCalculator menses = new MyMenstrualCycleCalculator();
        menses. displayCalculatorInMainMethod();
